#' @title Country Code Translation Data Frame (Cross-Sectional)
#'
#' @description The countrylist dataframe from the [countrycode] package. Use internally to generate summary statistics.
#' Names have been cleaned using janitor to replace "." with "_". Documentation is taken directly from the countrycode::countrylist() function.
